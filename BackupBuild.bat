...
"%TOOLCHAIN%\g++.exe" -c -m32 -fpermissive -O2 -ffunction-sections -fdata-sections -fomit-frame-pointer -fstack-protector -D_FORTIFY_SOURCE=2 -Wno-unused-variable -Wno-unused-parameter -Wno-sign-compare -Wno-deprecated-declarations -Wattributes -Wno-unknown-pragmas -Wno-missing-field-initializers -D_UNICODE -DUNICODE -DNOVTABLE= -D_WIN32_WINNT=0x0501 -DNDEBUG "WinMainUnit.cpp" -o "C:\Builder Projects\Base64\WinMainUnit.o"
if errorlevel 1 goto :fail
:skip_2
...
"%TOOLCHAIN%\g++.exe" -c -m32 -fpermissive -O2 -ffunction-sections -fdata-sections -fomit-frame-pointer -fstack-protector -D_FORTIFY_SOURCE=2 -Wno-unused-variable -Wno-unused-parameter -Wno-sign-compare -Wno-deprecated-declarations -Wattributes -Wno-unknown-pragmas -Wno-missing-field-initializers -D_UNICODE -DUNICODE -DNOVTABLE= -D_WIN32_WINNT=0x0501 -DNDEBUG "CommonFuncsUnit.cpp" -o "C:\Builder Projects\Base64\CommonFuncsUnit.o"
if errorlevel 1 goto :fail
:skip_5
...
"%TOOLCHAIN%\g++.exe" -c -m32 -fpermissive -O2 -ffunction-sections -fdata-sections -fomit-frame-pointer -fstack-protector -D_FORTIFY_SOURCE=2 -Wno-unused-variable -Wno-unused-parameter -Wno-sign-compare -Wno-deprecated-declarations -Wattributes -Wno-unknown-pragmas -Wno-missing-field-initializers -D_UNICODE -DUNICODE -DNOVTABLE= -D_WIN32_WINNT=0x0501 -DNDEBUG "ItsAMysteryUnit.cpp" -o "C:\Builder Projects\Base64\ItsAMysteryUnit.o"
if errorlevel 1 goto :fail
:skip_6
...
"%TOOLCHAIN%\g++.exe" -O2 -static -mwindows -m32 -Wl,--gc-sections -Wl,--gc-sections -s -municode "C:\Builder Projects\Base64\MainWindowResource.o" "C:\Builder Projects\Base64\WinMainUnit.o" "C:\Builder Projects\Base64\MainWindowUnit.o" "C:\Builder Projects\Base64\EncodeDecodeThreadUnit.o" "C:\Builder Projects\Base64\CommonFuncsUnit.o" "C:\Builder Projects\Base64\ItsAMysteryUnit.o" -o "Base64.exe" -lssp -lstdc++ -lshell32 -luuid -lcomdlg32 -lcomctl32 -lversion -lshlwapi -lole32
if errorlevel 1 goto :fail
:skip_7
"%TOOLCHAIN%\g++.exe" -O2 -static -mwindows -m32 -Wl,--gc-sections -Wl,--gc-sections -s -municode "C:\Builder Projects\Base64\MainWindowResource.o" "C:\Builder Projects\Base64\WinMainUnit.o" "C:\Builder Projects\Base64\MainWindowUnit.o" "C:\Builder Projects\Base64\EncodeDecodeThreadUnit.o" "C:\Builder Projects\Base64\CommonFuncsUnit.o" "C:\Builder Projects\Base64\ItsAMysteryUnit.o" -o "Base64.exe" -lssp -lstdc++ -lshell32 -luuid -lcomdlg32 -lcomctl32 -lversion -lshlwapi -lole32
if errorlevel 1 goto :fail
